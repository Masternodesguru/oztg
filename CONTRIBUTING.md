Contributing to OZTG Core
============================

The OZTG Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OZTG Core project, and is not to be
confused with overall OZTG Network Protocol consensus changes.

Whether a pull request is merged into OZTG Core rests with the project merge
...
Patches that change OZTG consensus rules are considerably more involved than
...
Where a patchset proposes to change the OZTG consensus, it must have been
...
The project leader is the release manager for each OZTG Core release.
