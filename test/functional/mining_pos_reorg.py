...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected OZTG and zOZTG supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zOZTGsupply']:
                assert_equal(node['zOZTGsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check OZTG and zOZTG supply at the beginning
        # ------------------------------------------
        # zOZTG supply: 2 coins for each denomination
        ...
        # OZTG supply: block rewards minus burned fees for minting
        ...
        # Verify that OZTG and zOZTG supplies were properly updated after the spends and reorgs
        self.log.info("Check OZTG and zOZTG supply...")
