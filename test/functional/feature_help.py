...
"""Verify that starting OZTG with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start OZTG with -? for help text")
        ...
        self.log.info("Start OZTG with -version for version information")
