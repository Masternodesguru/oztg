...
#define MyAppName "OZTG Core"
#define MyAppPublisher "2021-2022 The OZTG Developers"
#define MyAppURL "https://github.com/masternodesguru/oztg/OZTG"
#define MyAppExeName "OZTG-qt.exe"
#define MyAppExtraData "https://github.com/masternodesguru/oztg/OZTG/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\OZTG-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\OZTG\OZTG-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\OZTG\OZTG-Qt,strDataDir|{userappdata}\OZTG\}');
  Result := True;
end;
