...
* Fill in the following data:
    * Application Name: `OZTG Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The OZTG Developers`
    * Application Website: `https://masternodes.guru/oztg/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `OZTG`
* Add application files:
    * Select the file `OZTG-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `OZTG-2.0.0-win64-setup.exe`
