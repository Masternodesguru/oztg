...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='OZTG.conf'
CONFIGFOLDER='/root/.OZTG'
COIN_DAEMON='OZTGd'
COIN_CLI='OZTG-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/OZTG/OZTG/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
