...
const char * const PIVX_CONF_FILENAME = "OZTG.conf";
const char * const PIVX_PID_FILENAME = "OZTG.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\OZTG
// Windows >= Vista: C:\Users\Username\AppData\Roaming\OZTG
// Mac: ~/Library/Application Support/OZTG
// Unix: ~/.OZTG
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "OZTG";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty OZTG.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=28164\naddnode=seed1.masternodes.guru/oztg:28165\naddnode=seed2.masternodes.guru/oztg:28165\naddnode=seed3.masternodes.guru/oztg:28165\naddnode=seed4.masternodes.guru/oztg:28165\naddnode=seed5.masternodes.guru/oztg:28165\naddnode=seed6.masternodes.guru/oztg:28165\naddnode=seed7.masternodes.guru/oztg:28165\naddnode=seed8.masternodes.guru/oztg:28165\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override OZTG.conf
