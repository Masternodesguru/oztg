...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if (nHeight >   7000000) return     0 * COIN;
    if (nHeight >   6000000) return     0.08789 * COIN;
    if (nHeight >   5000000) return     0.17578 * COIN;
    if (nHeight >   4000000) return     0.35156 * COIN;
    if (nHeight >   3000000) return     0.70313 * COIN;
    if (nHeight >   2000000) return     1.40625 * COIN;
    if (nHeight >   1500000) return     2.8125 * COIN;
    if (nHeight >    800000) return     5.625 * COIN;
    if (nHeight >    500000) return     11.25  * COIN;
    if (nHeight >    200000) return     22.5 * COIN;
    if (nHeight >         2) return     45 * COIN;
    if (nHeight >         1) return     703000000 * COIN;
...
{																		 
    if(nHeight > 200) return GetBlockValue(nHeight) * 70 / 100;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 OZTG tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 OZTG tx -> 1 confirmation
