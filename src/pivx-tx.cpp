...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OZTG OZTG-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  OZTG-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded OZTG transaction") + "\n" +
                               "  OZTG-tx [options] -create [commands]   " + _("Create hex-encoded OZTG transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded OZTG transaction
