...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OZTG features */
        {"OZTG", "listmasternodes", &listmasternodes, true },
        {"OZTG", "getmasternodecount", &getmasternodecount, true },
        {"OZTG", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"OZTG", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"OZTG", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"OZTG", "masternodecurrent", &masternodecurrent, true },
        {"OZTG", "startmasternode", &startmasternode, true },
        {"OZTG", "createmasternodekey", &createmasternodekey, true },
        {"OZTG", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"OZTG", "listmasternodeconf", &listmasternodeconf, true },
        {"OZTG", "getmasternodestatus", &getmasternodestatus, true },
        {"OZTG", "getmasternodewinners", &getmasternodewinners, true },
        {"OZTG", "getmasternodescores", &getmasternodescores, true },
        {"OZTG", "mnsync", &mnsync, true },
        {"OZTG", "spork", &spork, true },
...
{
    return "> OZTG-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28164/\n";
}
